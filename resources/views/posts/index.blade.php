    ...
    <div class="max-w-7xl mx-auto px-2 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3   gap-6">
            ...
            @foreach ($posts as $post)
                <article class="w-full h-80 bg-cover bg-center @if($loop->first) md:col-span-2 @endif" style="background-image: url(@if($post->image){{Storage::url($post->image->url)}} @else https://images.pexels.com/photos/30970419/pexels-photo-30970419/free-photo-of-noche-lluviosa-en-un-vibrante-callejon-de-tokio.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2 @endif)">     
